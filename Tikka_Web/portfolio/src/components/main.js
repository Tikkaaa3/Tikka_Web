export default function main() {
  ...
  <div class="flex flex-col items-center custom-sm:flex-row justify-between custom-sm:items-stretch">
    <div class="custom-sm:pl-48 order-2 custom-sm:order-1">
      ...
      <button id="custom-button" type="button" class="transition ease-in-out hover:-translate-y-1 text-white p-2 rounded-md bg-gradient-to-r via-custom-light-red from-custom-dark-red to-custom-red hover:from-custom-blue hover:to-black">
      Show CV
    </button>
